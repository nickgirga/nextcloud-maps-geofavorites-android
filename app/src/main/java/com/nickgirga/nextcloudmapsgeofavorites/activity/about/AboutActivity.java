...
package com.nickgirga.nextcloudmapsgeofavorites.activity.about;
...
import com.nickgirga.nextcloudmapsgeofavorites.BuildConfig;
...
public class AboutActivity extends NextcloudMapsStyledActivity {
    ...
    private void fillAboutActivity () {
        ...
        TextView tvOriginal = findViewById(R.id.about_original);
        tvOriginal.setText(Html.fromHtml(getString(R.string.about_original)));
        tvOriginal.setOnClickListener(view -> openUtl("https://github.com/penguin86/nextcloud-maps-client"));
